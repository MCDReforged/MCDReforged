...
[English](https://github.com/Fallen-Breath/MCDReforged/blob/master/docs/plugin.md)
...
`text` 可为一个 `str` 或者 [`RTextBase`](https://github.com/Fallen-Breath/MCDReforged/blob/master/docs/utils.md#rtextbase) (`RText`, `RTextList`)
...
[工具文档](https://github.com/Fallen-Breath/MCDReforged/blob/master/docs/utils_cn.md)
