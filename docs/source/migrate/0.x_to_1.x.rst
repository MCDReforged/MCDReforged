...
MCDR also provides a simple function decorator :func:`@new_thread <mcdreforged.api.decorator.new_thread.new_thread>` for lazy man,
to make a function multi threaded when being invoked. Here's an quick example:
...
.. seealso::
    ...
    :doc:`/plugin_dev/command` document
