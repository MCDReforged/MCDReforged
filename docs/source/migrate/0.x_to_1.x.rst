...
With the :func:`@new_thread <mcdreforged.api.decorator.new_thread.new_thread>` decorator, everytime when you invoke ``my_slow_method2``\ , a new daemon thread will be started to executed it
