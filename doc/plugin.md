...
[中文](https://github.com/Fallen-Breath/MCDReforged/blob/archive/0.x/doc/plugin_cn.md)
...
`text` could be a `str` or [`RTextBase`](https://github.com/Fallen-Breath/MCDReforged/blob/archive/0.x/doc/utils.md#rtextbase) (`RText`, `RTextList`)
...
[Plugin document](https://github.com/Fallen-Breath/MCDReforged/blob/archive/0.x/doc/utils.md)
